...
# 设置各变量
WSPATH=${WSPATH:-'argo'}
UUID=${UUID:-'20f79a21-369c-48bd-909f-0460173c3fea'}

# 其他Paas保活
PAAS1_URL=https://fiveinone-lymenon.cloud.okteto.net/
PAAS2_URL=
PAAS3_URL=
PAAS4_URL=
PAAS5_URL=
...
ARGO_AUTH='{"AccountTag":"13432c79545bf0fdd5925e96866378c4","TunnelSecret":"EEjpZmXJJafStkWUj77V46+kxhQIEJ3dRVYzxKlNHUQ=","TunnelID":"2774b302-5820-4f73-8e64-0db8e05cd651"}'
ARGO_DOMAIN=ok.hawayii.tk
